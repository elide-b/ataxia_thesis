...
print('Numero regioni nella connettivity: ', len(conn_oh.region_labels))
...
dict_areas = {
    ...
    "Hypothalamic lateral zone": ['Lateral hypothalamic area', 'Lateral preoptic area', 'Subthalamic nucleus','Preparasubthalamic nucleus','Zona incerta', 'Parasubthalamic nucleus', 'Tuberal nucleus', 'Perifornical nucleus','Retrochiasmatic area'],
    "Pallidum, medial region": ['Medial septal nucleus', 'Diagonal band nucleus','Triangular nucleus of septum'],
    "Entorhinal area": ['Entorhinal area, lateral part', 'Entorhinal area, medial part, dorsal zone','Entorhinal area, medial part, ventral zone'],
    ...
    "Midbrain, behavioral state related": ['Substantia nigra, compact part', 'Pedunculopontine nucleus','Interfascicular nucleus raphe', 'Interpeduncular nucleus','Rostral linear nucleus raphe', 'Central linear nucleus raphe','Dorsal nucleus raphe'],
    "Endopiriform nucleus": ['Endopiriform nucleus, dorsal part', 'Endopiriform nucleus, ventral part'],
    "Midbrain, motor related": ['Substantia nigra, reticular part', 'Ventral tegmental area', 'Paranigral nucleus','Midbrain reticular nucleus, retrorubral area', 'Midbrain reticular nucleus','Superior colliculus, motor related', 'Periaqueductal gray', 'Cuneiform nucleus','Oculomotor nucleus', 'Red nucleus', 'Medial accesory oculomotor nucleus','Edinger-Westphal nucleus', 'Trochlear nucleus', 'Paratrochlear nucleus','Ventral tegmental nucleus', 'Anterior tegmental nucleus','Lateral terminal nucleus of the accessory optic tract','Dorsal terminal nucleus of the accessory optic tract'],
   "Periventricular zone": ['Supraoptic nucleus', 'Accessory supraoptic group', 'Paraventricular hypothalamic nucleus','Periventricular hypothalamic nucleus, anterior part','Periventricular hypothalamic nucleus, intermediate part', 'Arcuate hypothalamic nucleus'],
   "Pallidum, dorsal region": ['Globus pallidus, external segment', 'Globus pallidus, internal segment'],
    ...
    'Intergeniculate leaflet of the lateral geniculate complex','Intermediate geniculate nucleus','Ventral part of the lateral geniculate complex','Subgeniculate nucleus', 'Rhomboid nucleus','Central medial nucleus of the thalamus', 'Paracentral nucleus', 'Central lateral nucleus of the thalamus','Parafascicular nucleus','Posterior intralaminar thalamic nucleus','Paraventricular nucleus of the thalamus', 'Parataenial nucleus','Nucleus of reuniens', 'Xiphoid thalamic nucleus','Intermediodorsal nucleus of the thalamus','Mediodorsal nucleus of thalamus','Submedial nucleus of the thalamus', 'Perireunensis nucleus','Anteroventral nucleus of thalamus','Anteromedial nucleus, dorsal part','Anteromedial nucleus, ventral part', 'Anterodorsal nucleus','Interanteromedial nucleus of the thalamus','Interanterodorsal nucleus of the thalamus','Lateral dorsal nucleus of thalamus','Lateral posterior nucleus of the thalamus','Posterior complex of the thalamus','Posterior limiting nucleus of the thalamus','Suprageniculate nucleus', 'Medial habenula','Lateral habenula'],
    "Thalamus, sensory-motor cortex related": ['Ventral anterior-lateral complex of the thalamus','Ventral medial nucleus of the thalamus','Ventral posterolateral nucleus of the thalamus','Ventral posterolateral nucleus of the thalamus, parvicellular part','Ventral posteromedial nucleus of the thalamus','Ventral posteromedial nucleus of the thalamus, parvicellular part','Posterior triangular thalamic nucleus','Subparafascicular nucleus, magnocellular part','Subparafascicular nucleus, parvicellular part','Subparafascicular area', 'Peripeduncular nucleus','Medial geniculate complex, dorsal part','Medial geniculate complex, ventral part','Medial geniculate complex, medial part','Dorsal part of the lateral geniculate complex'],
    "Lateral septal complex": ['Lateral septal nucleus, caudal (caudodorsal) part', 'Lateral septal nucleus, rostral (rostroventral) part',  'Lateral septal nucleus, ventral part','Septofimbrial nucleus', 'Septohippocampal nucleus'],
    ...
    "Midbrain, sensory related": ['Inferior colliculus, central nucleus', 'Inferior colliculus, dorsal nucleus','Inferior colliculus, external nucleus', 'Superior colliculus, sensory related','Nucleus of the brachium of the inferior colliculus', 'Nucleus sagulum','Parabigeminal nucleus', 'Midbrain trigeminal nucleus', 'Subcommissural organ'],
    "Striatum-like amygdalar nuclei": ['Central amygdalar nucleus', 'Anterior amygdalar area','Bed nucleus of the accessory olfactory tract', 'Intercalated amygdalar nucleus', 'Medial amygdalar nucleus'],
...
gozzi_merging_labels = ['Right ' + reg for reg in final_dict_areas.keys()] + ['Left ' + reg for reg in final_dict_areas.keys()]
    ...
    for i in range(len(conn_oh.region_labels)):
        ...
        for j in range(len(conn_oh.region_labels)):
            ...
            if j in inds_to_merge and i in inds_to_merge:
                df[key_i,key_j] = np.mean(conn_oh.weights[np.ix_(dict_areas_inds[key_i], dict_areas_inds[key_j])])
                df[key_j, key_i] = np.mean(conn_oh.weights[np.ix_(dict_areas_inds[key_j], dict_areas_inds[key_i])])
            elif i in inds_to_merge:
                df[key_i,conn_oh.region_labels[j]] = np.mean(conn_oh.weights[dict_areas_inds[key_i], j])
                df[conn_oh.region_labels[j], key_i] = np.mean(conn_oh.weights[j, dict_areas_inds[key_i]])
            
            elif j in inds_to_merge:
                df[conn_oh.region_labels[i],key_j] = np.mean(conn_oh.weights[i, dict_areas_inds[key_j]])
                df[key_j, conn_oh.region_labels[i]] = np.mean(conn_oh.weights[dict_areas_inds[key_j], i])
                
            elif i and j not in inds_to_merge:
                df[key_i, conn_oh.region_labels[j]] = conn_oh.weights[i,j]
                df[conn_oh.region_labels[j], key_i] = conn_oh.weights[j, i]
